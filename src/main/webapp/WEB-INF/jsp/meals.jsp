    ...
    <div class="container">
        <div class="shadow">
            ...
            <form id="filterForm" method="post" action="meals/filter">
                ...
                <a class="btn btn-primary" onclick="document.getElementById('filterForm').submit()" >
                    <span class="glyphicon glyphicon-filter" aria-hidden="true"></span>
                    <spring:message code="meal.filter"/>
                </a>
                <a class="btn btn-warning" href="meals">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="text" class="form-control" id="description" name="description" size=40 placeholder="<spring:message code="meal.description"/>">
                        </div>
                    </div>
