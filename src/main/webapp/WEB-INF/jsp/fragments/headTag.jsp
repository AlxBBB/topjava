...
<head>
    ...
    <script type="text/javascript" src="webjars/bootstrap/3.3.7-1/js/collapse.js" defer></script>
    <script type="text/javascript" src="webjars/bootstrap/3.3.7-1/js/bootstrap.min.js" defer></script>
    <script type="text/javascript" src="webjars/Eonasdan-bootstrap-datetimepicker/4.17.47/js/bootstrap-datetimepicker.min.js" defer></script>
