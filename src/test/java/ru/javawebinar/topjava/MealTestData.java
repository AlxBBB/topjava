...
public class MealTestData {
    ...
    public static final List<MealWithExceed> MEALS_WITH_EXCEED = MealsUtil.getWithExceeded(MEALS, UserTestData.USER.getCaloriesPerDay());
    public static final List<MealWithExceed> MEALS_BETWEEN=Arrays.asList(createWithExceed(MEAL5, true),createWithExceed(MEAL4, true));
